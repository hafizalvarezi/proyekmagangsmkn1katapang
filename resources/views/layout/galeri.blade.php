 ...
 <!-- card 2 -->
            ...
            <div class="col-xl-4">
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                    <div class="text-center">
  <img src="foto/dda.jpg" class="rounded"  height="200px" width="300px">
 <h3>Lapangan Upacara</h3>
Lapangan di SMKN 1 Katapang ada 2.Yang pertama sering dipakai untuk upacara dan lapangan yang kedua sering dipakai untuk olahraga</div>
                    </div>
                </div>
                </div>
     ...
     <!-- card 3 -->
            <div class="col-xl-4">
                <div class="card mb-4 mb-xl-0">
                    <div class="card-header" align="center">Prestasi</div>
                    <div class="card-body text-center">
                    <div class="text-center">
 ...
 Rekayasa Perangkat Lunak adalah profesi yang mendalami cara-cara pengembangan perangkat lunak termasuk pembuatan,dan manajemen organisasi pengembangan perangkat lunak.</div>
     ...
     <!-- card 6 -->            
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                    <div class="text-center">
  <img src="foto/multi.png" class="rounded"  height="200px" width="250px">
 <h3>MultiMedia</h3>
