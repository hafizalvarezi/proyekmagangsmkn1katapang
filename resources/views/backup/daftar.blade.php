...
<form action="{{route('simpandaftar')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="container">
    ...
    <input type="number" placeholder="Masukan NIS MAX=10" name="nis" required pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;"><br><br>
    ...
    <button class="btnsub" type="submit">Daftar</button><br>
    <h3><strong>Peringatan</strong> Jenis Kelamin dan <strong>Tanggal Lahir</strong> Tidak Bisa diganti di Edit !</h3>
  </div>
