                ...
                <div class="page-breadcrumb">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-8 align-self-center">
                            <h3 class="page-title mb-0 p-0">Daftar Hewan</h3>
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li> 
                                        <li class="breadcrumb-item">Daftar Hewan</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table user-table no-wrap">
                                          ...
                                          <tr>
                                            @foreach ($dtupload as $item)
                                            <td><img src="{{asset ( 'image/'.$item->foto) }}" width="80px" height="80px" alt="not found" srcset=""></td>
                                            <td>{{$item->jenis}}</td>
                                            <td>{{$item->harga}}</td>
                                            <td>{{$item->deskripsi}}</td>
                                            <td><a href={{url('edit',$item->id)}}><i class="fa-solid fa-square-pen"></i></a>
                                              | 
                                                <a href={{url('delete',$item->id)}}><i class="fa-solid fa-trash-can"></i></a>
                                            </td>
                                            @endforeach
                                          </tr>
                                        </table>
                                        <button type="button" class="btn btn-outline-primary" ><a href="{{route('create')}}" >Tambah Data</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
