  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <img src="../image/MenuKopi/Vanilla.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Vanilla</h5>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 200px;">
        <img src="../image/MenuKopi/Caramel.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Caramel</h5>
          <p class="card-text">Rp 30.000</p>
          <a href="#" class="btn btn-primary">Beli</a>
        </div>
</div>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 200px;">
        <img src="../image/MenuKopi/Brulle.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Brulle</h5>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 200px;">
        <img src="../image/MenuKopi/Macchiato.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Macchiato</h5>
