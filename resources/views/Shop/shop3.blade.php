  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <img src="../image/MenuKopi/Piccolo.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Piccolo</h5>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 200px;">
        <img src="../image/MenuKopi/Cafe Latte.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Cafe Latte</h5>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 200px;">
        <img src="../image/MenuKopi/Hazelnut Latte.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Hazelnut Latte</h5>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 200px;">
        <img src="../image/MenuKopi/Matcha Latte.png" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title m-1">Matcha Latte</h5>
          <p class="card-text">Rp 22.000</p>
          <a href="#" class="btn btn-primary">Beli</a>
        </div>
</div>
